...
import { AddStockItemAutoUsecaseInterface, DeleteStockItemAutoUsecaseInterface } from "../../domain/usecases";
import { PrismaStockItemAutoRepository } from "../../infra/repositories";
import { AddStockItemAutoUsecase, DeleteStockItemAutoUsecase } from "../../application/usecases";
    ...
    static create(): DeleteStockItemAutoUsecaseInterface {
        ...
        const execute = async (input: DeleteStockItemAutoUsecaseInterface.InputDto): Promise<DeleteStockItemAutoUsecaseInterface.OutputDto> => {
            return await prismaClient.$transaction(async (prisma) => {
                ...
                const deleteStockItemAutoUsecase = new DeleteStockItemAutoUsecase(
